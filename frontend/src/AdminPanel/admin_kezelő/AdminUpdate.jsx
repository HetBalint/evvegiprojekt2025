            ...
            .then(res => {
                if (res.data.length > 0) {
                    setValues({
                        ...
                        jelszo: res.data[0].jelszo, // Hozzáadva a jelszó
    ...
    const handleUpdate = async (event) => {
      ...
      try {
          const res = await axios.put(`http://localhost:8081/admin/adminlist/update/${id}`, {
              ...values,
              szulev: formattedDate // Csak az év-hónap-nap részét küldjük az adatbázisba
          });
                    ...
                    <div className="card shadow-lg p-4">
                        ...
                        <form onSubmit={handleUpdate}>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="password" id="jelszo" className="form-control"
                                    value={values.jelszo}
                            ...
                            <div className="mb-3">
                                ...
                                <input type="number" id="telszam" className="form-control"
